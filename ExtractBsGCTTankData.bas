...
Public Sub ExtractAllBsGCTTankData()
  ...
  Call ExtractTankMainDataToJson(Sheet3.range("B4:G4"), Sheet3.range("B5:G200"), 200, 6, myTxt, "SupportData")
  Call ExtractTankMainDataToJson(Sheet4.range("B4:H4"), Sheet4.range("B5:H200"), 200, 7, myTxt, "PressureElementData")
